...
module.exports.logIn = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(name, password) {
    var res, _t;
...
module.exports.logOut = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
  var res, _t2;
...
//
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"stories.js":[function(require,module,exports) {
"use strict";
...
module.exports.uploadStory = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
    var formData, finFiles, commFiles, contFiles, res, uploadModal, uploadForm, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          e.preventDefault();
          formData = new FormData();
          formData.append("firstContact", document.getElementById("firstContact").value);
          ...
          formData.append("financialImpact", document.getElementById("financialImpact").value);
          formData.append("victimContact", document.getElementById("victimContact").value);
          finFiles = Array.from(document.getElementById("financialRecords").files);
          commFiles = Array.from(document.getElementById("communicationRecords").files);
          contFiles = Array.from(document.getElementById("contractsAgreements").files);
          console.log(finFiles);
          finFiles.forEach(function (file) {
            return formData.append("financialRecords", file);
          });
          commFiles.forEach(function (file) {
            return formData.append("communicationRecords", file);
          });
          contFiles.forEach(function (file) {
            return formData.append("contractsAgreements", file);
          });
        ...
        case 3:
          _context.p = 3;
          _t = _context.v;
          alert("Error uploading story: " + _t.response.data.message);
        case 4:
          return _context.a(2);
      }
    }, _callee, null, [[1, 3]]);
...
module.exports.searchStories = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
  var searchInput, resultsContainer, query, url, ids, res, _t2;
  return _regenerator().w(function (_context2) {
    while (1) switch (_context2.p = _context2.n) {
      case 0:
      ...
      case 1:
        ...
        if (query) {
          if (query.includes(",")) {
            ids = query.split(",").map(function (id) {
              return id.trim();
            }).filter(function (id) {
              return id;
            });
            url = "/api/v1/stories?search=".concat(encodeURIComponent(ids.join(",")));
          } else {
            url = "/api/v1/stories?search=".concat(encodeURIComponent(query));
          }
        }
        _context2.n = 3;
        return (0, _axios.default)({
      ...
      case 4:
        ...
        if (resultsContainer) {
          resultsContainer.innerHTML = '<p class="dashboard__placeholder">Error loading stories.</p>';
        }
      case 5:
        return _context2.a(2);
    }
...
var displayStories = function displayStories(stories) {
  ...
  if (!stories || stories.length === 0) {
    resultsContainer.innerHTML = '<p class="dashboard__placeholder">No stories found.</p>';
    return;
  }
  resultsContainer.innerHTML = stories.map(function (story) {
    return "\n    <div class=\"dashboard__story-card\">\n      <div class=\"dashboard__story-info\">\n        <p class=\"dashboard__story-id\">Story ID: ".concat(story.storyId, "</p>\n        <p class=\"dashboard__story-email\">").concat(story.victimContact, "</p>\n      </div>\n      <div class=\"dashboard__story-actions\">\n        <button class=\"btn btn--small btn--edit\" data-story-id=\"").concat(story._id, "\">Edit</button>\n        <button class=\"btn btn--small btn--delete\" data-story-id=\"").concat(story._id, "\">Delete</button>\n      </div>\n    </div>\n  ");
  }).join("");
};
module.exports.deleteStory = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(id) {
    var _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          console.log("deleting: ".concat(id));
        ...
        case 1:
          ...
          return (0, _axios.default)({
            method: "DELETE",
            url: "/api/v1/admin__dashboard/".concat(id)
          });
        case 2:
        ...
        case 3:
          _context3.p = 3;
          _t3 = _context3.v;
          alert("Error deleting story: " + _t3.response.data.message);
        case 4:
          return _context3.a(2);
      }
    }, _callee3, null, [[1, 3]]);
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        ...
        case 2:
          _context4.p = 2;
          _t4 = _context4.v;
          alert("Error updating story: " + _t4.response.data.message);
        case 3:
...
},{"axios":"../../node_modules/axios/index.js"}],"fileViewer.js":[function(require,module,exports) {
...
var closeBtn = document.querySelector(".file-modal__close");
var prevBtn = document.querySelector(".file-modal__prev");
var nextBtn = document.querySelector(".file-modal__next");
var caption = document.querySelector(".file-modal__caption");

// Open modal when clicking on any file card
document.querySelectorAll(".story-detail__file-card").forEach(function (card) {
  card.addEventListener("click", function () {
    var filePath = this.dataset.file;
    var gallery = this.dataset.gallery;

    // Get all files in the same gallery
    currentGallery = Array.from(document.querySelectorAll("[data-gallery=\"".concat(gallery, "\"]"))).map(function (el) {
      var _el$querySelector, _el$querySelector2;
      return {
        path: el.dataset.file,
        name: ((_el$querySelector = el.querySelector(".file-name")) === null || _el$querySelector === void 0 ? void 0 : _el$querySelector.textContent) || ((_el$querySelector2 = el.querySelector("img")) === null || _el$querySelector2 === void 0 ? void 0 : _el$querySelector2.alt) || ""
      };
    });
...
function showFile(index) {
  ...
  currentIndex = index;
  var file = currentGallery[index];
  var isPDF = file.path.toLowerCase().endsWith(".pdf");
  if (isPDF) {
  ...
  caption.textContent = "".concat(currentIndex + 1, " / ").concat(currentGallery.length, " - ").concat(file.name);
...
var _require2 = require("./stories"),
  uploadStory = _require2.uploadStory,
  searchStories = _require2.searchStories,
  updateStory = _require2.updateStory,
  deleteStory = _require2.deleteStory,
  displayStories = _require2.displayStories;
...
var logOutBtn = document.querySelector(".nav__item--logout");
...
var closeUpdateModal = document.querySelector(".modal__close--update");
    ...
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            e.preventDefault();
            storyId = document.getElementById("updateStoryId").value;
            data = {
            ...
            _context.n = 1;
            return updateStory(storyId, data);
          case 1:
            return _context.a(2);
        }
      }, _callee);
...
if (resultsContainer) {
  resultsContainer.addEventListener("click", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(e) {
      var deleteBtn, editBtn, storyId, _storyId, storyCard, storyIdText, email, res, data, story, _t;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            e.preventDefault();
            ...
            storyId = deleteBtn.dataset.storyId;
            _context2.n = 1;
          ...
          case 1:
            ...
            _storyId = editBtn.dataset.storyId; // Get the story data from the card
            storyCard = editBtn.closest(".dashboard__story-card");
            storyIdText = storyCard.querySelector(".dashboard__story-id").textContent.replace("Story ID: ", "");
            email = storyCard.querySelector(".dashboard__story-email").textContent; // Fetch full story details from API
            _context2.p = 2;
            _context2.n = 3;
            return fetch("/api/v1/stories?search=".concat(encodeURIComponent(storyIdText)));
          case 3:
            res = _context2.v;
            _context2.n = 4;
            return res.json();
          case 4:
            ...
            if (data.data.data && data.data.data.length > 0) {
              story = data.data.data[0]; // Prefill the update form
              document.getElementById("updateStoryId").value = story._id;
              document.getElementById("updateFirstContact").value = story.firstContact;
              document.getElementById("updatePromised").value = story.promised;
              document.getElementById("updateRealization").value = story.realization;
              document.getElementById("updateFinancialImpact").value = story.financialImpact;
              document.getElementById("updateVictimContact").value = story.victimContact;
          ...
          case 5:
            _context2.p = 5;
            _t = _context2.v;
            alert("Error loading story details: " + _t.message);
          case 6:
            return _context2.a(2);
        }
      }, _callee2, null, [[2, 5]]);
